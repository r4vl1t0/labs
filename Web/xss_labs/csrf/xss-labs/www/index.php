...
<div class="container" style="max-width:900px;">
  ...
  <div class="lab-grid">
    ...
    <div class="lab-card">
      <h4>8. CSRF en transferencias</h4>
      <p>App bancaria con demo de pagina maliciosa lista para mostrar.</p>
      <a class="btn" href="/profesor/csrf/login.php">Abrir</a>
    </div>
  </div>
  ...
  <div class="lab-grid">
    ...
    <div class="lab-card">
      <h4>7. Reto XSS + Blacklist</h4>
      <p>Fuzzea etiquetas HTML para evadir un filtro de blacklist.</p>
      <a class="btn" href="/estudiante/blacklist/">Abrir</a>
    </div>
    <div class="lab-card">
      <h4>9. Reto CSRF en transferencias</h4>
      <p>Fuerza una transferencia sin usar el formulario legitimo.</p>
      <a class="btn" href="/estudiante/csrf/login.php">Abrir</a>
    </div>
  </div>
</div>
</body>
