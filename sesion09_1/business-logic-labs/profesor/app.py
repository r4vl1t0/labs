...
COUPON_DISCOUNT = 10  # porcentaje

FLAG = "FLAG{profesor_cadena_l0gica_neg0cio_x9k2m}"

# Usuario cuyas credenciales estan expuestas en el panel de login (rectangulo)
LEAKED_USERNAME = "cronaldo@fifa2026.com"
LEAKED_PASSWORD = "Portugal2026@"
